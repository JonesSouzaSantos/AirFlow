...
import superdigital_de.di.retorno_campanha_email as facade
...
dag = DAG('cm_n5__retorno_campanha_email',
          description='DAG responsavel pela analise do Retorno de Campanha de Emails do Campaign Manager N5.',
