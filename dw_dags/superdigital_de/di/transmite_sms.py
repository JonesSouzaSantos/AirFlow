...
from superdigital_de.di.repositorios import ExecutionLog, OutputSegmentadorSMS, Campanha, Canal, CampanhaContatoSMS, \
...
class BusinessObject(object):
    ...
    def disparar_sms(self, campanha, id_execution):
        ...
        for _sms in self.obter_output_sms(id_definition, id_execution):
            ...
            b.add_binds({BatchSMSBuilder.BIND_CELULAR: _sms[OutputSegmentadorSMS.TELEFONE],
                         BatchSMSBuilder.BIND_MENSAGEM: _sms[OutputSegmentadorSMS.MENSAGEM]})
    ...
    def obter_output_sms(self, id_definition, id_execution):
        return OutputSegmentadorSMS.findAll_by_IdDefinition_IdExecution_DataTransmissaoIsNull_notGC(id_definition,
                                                                                                    id_execution,
                                                                                                    conn=self.conn)
