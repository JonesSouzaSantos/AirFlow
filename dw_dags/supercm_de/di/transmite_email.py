...
from supercm_de.di.repositorios import ExecutionLog, Campanha, OutputSegmentadorEmail, ViewOutputSegmentadorEmail, Canal, \
                ...
                if not cd_lista:
                    ...
                    try:
                        ...
                        if df.empty:
                            ...
                            df_4_lista = df.drop(columns=[ViewOutputSegmentadorEmail.EMAIL,
                                                          ViewOutputSegmentadorEmail.CONTA_CORRENTE_ID])
                            ...
                            _is_ok = True
                            if _is_upload_ok:
                                logging.info('\t\tIdDefinition [%s] id_execution [%s] segmenta_ip[%s] msg_error[%s]'
                                             % (id_definition, id_execution, tribool_segmenta_ip, msg_error))
...
class BusinessObject(object):
    ...
    def buscar_dados_transmissao_as_df(self, id_definition, id_execution, tribool_segmenta_ip):
        ...
        _rs = ViewOutputSegmentadorEmail. \
        ...
        if not has_dados:
            ...
            count = ViewOutputSegmentadorEmail. \
            ...
            if has_envio_no_dia:
                ...
                _blank = {ViewOutputSegmentadorEmail.EMAIL: '',
                          ViewOutputSegmentadorEmail.CONTA_CORRENTE_ID: '',
                          ViewOutputSegmentadorEmail.HEADER_CAMPANHA: campanha[Campanha.TX_CAMPOS],
                          ViewOutputSegmentadorEmail.VALUES_CAMPANHA:
    ...
    def atualizar_status_lista(self, id_definition, id_execution, tribool_segmenta_ip, msg_error):
        ...
        OutputSegmentadorEmail.insertAll_dadosTransmissao_by_IdDefinition_IdExecution(
                id_definition=id_definition,
                id_execution=id_execution,
                tribool_segmenta_ip=tribool_segmenta_ip,
                conn=self.conn
